...
def _require_lightgbm():
    try:
        ...
        raise RuntimeError(
            "LightGBM is not installed in the active environment. Install it with "
            "`pip install lightgbm` or reinstall from requirements.txt before running training."
        ) from exc
...
def run_training():
    ...
    with start_run("lightgbm_training") as (mlflow, _):
